...
class Order:
    def __init__(self, name, number, order_type, order_items, is_Paid, is_Prerorder, preorder_date, preorder_date, discount_code, discount_amount, notes, delivery_address, delive):
        self.name = name
        self.number = number
